...
function handleTan(\Fhp\BaseAction $action) {
    ...
    if ($tanRequest->getChallengeHhdUc()) {
        $challengeImage = new \Fhp\Model\TanRequestChallengeImage($tanRequest->getChallengeHhdUc());
...
$tanMode = (int)$fints_config['api']['tanmode']; #  pushTAN is 921; // This is just a placeholder you need to fill!
$tanMedium = ($fints_config['api']['tanmedia'] != "") ? $fints_config['api']['tanmedia'] : null; // This is just a placeholder you may need to fill.
