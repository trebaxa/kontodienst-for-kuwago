...
$options->url = $fints_config['server']; // HBCI / FinTS Url can be found here: https://www.hbci-zka.de/institute/institut_auswahl.htm (use the PIN/TAN URL)
$options->bankCode = $fints_config['blz']; // Your bank code / Bankleitzahl
$options->productName = $INSTALL::get_regnum(); // The number you receive after registration / FinTS-Registrierungsnummer
$options->productVersion = '1.0'; // Your own Software product version
$credentials = \Fhp\Options\Credentials::create($fints_config['user'], $fints_config['pin']); // This is NOT the PIN of your bank card!
